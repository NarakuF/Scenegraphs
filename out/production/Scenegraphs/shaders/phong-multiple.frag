...
void main()
{
    vec3 lightVec,viewVec,reflectVec,locVec,spotVec;
    vec3 normalView;
    vec3 ambient,diffuse,specular;
    float nDotL,rDotV,sDotL;
    ...
    for (int i=0;i<numLights;i++)
    {
        ...
        spotVec = normalize(light[i].spotdirection.xyz);
        sDotL = dot(-lightVec, spotVec);
